...
export const LETICIA_DEMO_SCENARIO: LeticiaDemoScenario = {
  monitors: [{ id: "mon_lidal_availability", organizationId: "demo-leticia-2026", name: "Disponibilité produits LIDAL", objective: "issue", targetType: "product", targetName: "Produits LIDAL", aliases: ["LIDAL", "ليدال", "produit LIDAL"], exclusions: ["emploi", "recrutement"], languages: ["francais", "darija_arabe", "darija_arabizi"], territories: ["Oran", "Alger", "Constantine"], sources: ["facebook", "google_maps", "youtube", "tiktok"], competitors: [], frequencyMinutes: 180, maxMonthlyDocuments: 12_000, maxMonthlyCostDzd: 18_000, active: true, lastCollectedAt: "2026-08-18T10:15:00Z", coverageNote: "Scénario déterministe avec sources anonymisées." }],
  mentions: [
    ...
    { id: "m_oran_arabizi_05", text: "Rani dourt 3 magasins, ma kayench stock à Oran.", source: "tiktok", sourceUrl: "https://example.invalid/leticia/tiktok/m_oran_arabizi_05", publishedAt: "2026-08-18T10:02:00Z", language: "darija_arabizi", territory: "Oran", sentiment: "negatif", aspects: ["disponibilite"], annotationStatus: "valid" },
  ...
  overview: { period: { start: "2026-08-11T00:00:00Z", end: "2026-08-18T23:59:59Z", comparisonStart: "2026-08-04T00:00:00Z", comparisonEnd: "2026-08-10T23:59:59Z" }, qualifiedMentions: 8, collectedDocuments: 10, validAnnotations: 7, analyticalCoveragePercent: 87.5, netSentiment: -25, netSentimentDelta: -18, insufficientSample: false, distribution: { positif: 3, negatif: 4, neutre: 1, mixte: 0 }, negativeRatePercent: 50, openSignalsBySeverity: { critical: 0, high: 1, medium: 0, low: 0 }, medianTimeToOwnershipHours: 0.1, overdueActions: 0, topDrivers: [{ aspect: "Disponibilité", deltaPoints: -18, mentionCount: 5 }], sourceHealth: [{ source: "facebook", status: "healthy", successRatePercent: 100, freshnessMinutes: 12, collectedDocuments: 3, analyticalCoveragePercent: 100 }, { source: "google_maps", status: "healthy", successRatePercent: 100, freshnessMinutes: 18, collectedDocuments: 2, analyticalCoveragePercent: 100 }, { source: "youtube", status: "healthy", successRatePercent: 100, freshnessMinutes: 22, collectedDocuments: 2, analyticalCoveragePercent: 100 }, { source: "tiktok", status: "healthy", successRatePercent: 100, freshnessMinutes: 16, collectedDocuments: 3, analyticalCoveragePercent: 67 }] },
